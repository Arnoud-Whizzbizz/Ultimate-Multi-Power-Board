...
// AvD - Channel-1 Critical-Alert Limit = register 7
#define INA3221_CRITICAL_1    (0x07)
#define INA3221_CRITICAL_SUM  (0x0E)
...
class SDL_Arduino_INA3221{
 public:
  ...
  void setCriticalAlertValue(float mAmps, int channel);
